...
```bash
git clone https://github.com/davidvvvzhang/BUIR_ReChorus.git
```
...
#### 1.1 Dataset “Grocery_and_Gourmet_Food”
##### 1.1.1 Results of the BUIR_NB model
```plaintext
...
```
##### 1.1.2 Results of the BRRMF model
```plaintext
...
```
##### 1.1.3 Results of the NEUMF model
```plaintext
...
#### 1.2 Dataset "MIND_Large"
##### 1.2.1 Results of the BUIR_NB model
```plaintext
...
```
##### 1.2.2 Results of the BRRMF model
```plaintext
...
```
##### 1.2.3 Results of the NEUMF model
```plaintext
...
```
### 2. Improve experimental results

#### 2.1 Results of the original BUIR_NB model
```plaintext
===== [FINAL PERFORMANCE] =====
...
```
#### 2.2 Results of the BUIR_PYG model
```plaintext
===== [FINAL PERFORMANCE] =====
...
#### 2.3 Results of the BUIR_GAT model
```plaintext
===== [FINAL PERFORMANCE] =====
...
```
#### 2.4 Results of the BUIR_GCN Model
```plaintext
===== [FINAL PERFORMANCE] =====
